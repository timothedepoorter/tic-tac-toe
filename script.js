...
function handleCase() {
    ...
    if (((buttons[0].innerHTML == buttons[1].innerHTML) && (buttons[0].innerHTML == buttons[2].innerHTML)) && (buttons[0].innerHTML == "X" || buttons[0].innerHTML == "O")) {
        console.log(`Le joueur ${buttons[0].innerHTML} remporte la partie`);
        ...
        console.log(`Le joueur ${buttons[3].innerHTML} remporte la partie`);
        ...
        console.log(`Le joueur ${buttons[6].innerHTML} remporte la partie`);
        ...
        console.log(`Le joueur ${buttons[1].innerHTML} remporte la partie`);
        ...
        console.log(`Le joueur ${buttons[2].innerHTML} remporte la partie`);
